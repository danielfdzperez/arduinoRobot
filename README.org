...
<<<<<<< HEAD
   ...
   De esta forma, para cada uno de los canales si el enable está activado y
   los dos inputs valen 1 y 0, respectivamente, el motor girará en una
   dirección, mientras que si valen 0 y 1, girará en la otra.
=======
...
>>>>>>> 6906360de2b3d32b106f173ea07f705ed4c8779a
** Motor con encoder
